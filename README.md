...
- **Seguimiento de Pagos:** Registro de abonos y estados de cuenta automáticos.

## 🎨 Filosofía de Diseño
EduSoft no es solo funcional; es **estéticamente superior**.
- **Glassmorphism:** Interfaces con transparencias y desenfoque (blur) para una sensación moderna.
- **Micro-animaciones:** Transiciones suaves que mejoran la experiencia del usuario.
- **Paleta de Colores Curada:** Tonos pasteles y vibrantes que facilitan la lectura y reducen la fatiga visual.
...
3. Configurar variables de entorno (`.env`):
   ```env
  DATABASE_URL="postgresql://neondb_owner:npg_3ync5DGKsjbN@ep-steep-water-amuxzlyl-pooler.c-5.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require"
